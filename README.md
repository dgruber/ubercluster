...
- [**cf-tasks**]()cmd/cf-tasks/README.md): Example of a proxy which emits Cloud Foundry tasks as jobs.
- [**dockerproxy**](cmd/dockerproxy/README.md): Example of a proxy which runs Docker containers as jobs.
